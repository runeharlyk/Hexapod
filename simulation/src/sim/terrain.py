...
def randomize_hfield(model, rng, max_height):
    """Fill the 'terrain' hfield with smooth random bumps of amplitude [0, max_height] m."""
    ...
    h = _upsample_bilinear(rng.uniform(0.0, 1.0, (COARSE_N, COARSE_N)), nrow)

    # flat spawn disk with a smoothstep ramp out to full amplitude
